...
function SearchEmployee(){
  ...
  xhttp.open("POST", "/mycode/E-Commerce_Website/control/getSearchEmployee.php", true);
...
<br> <br>
<input type="text" placeholder="Enter user ID"  id="search" name="search" >
...
$userQuery = $connection->showAllEmployee($conobj,"users","Delivery man");
